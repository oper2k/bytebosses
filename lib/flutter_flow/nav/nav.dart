...
GoRouter createRouter(AppStateNotifier appStateNotifier) {
  ...
  return GoRouter(
    ...
    errorBuilder: (context, state) => GameWidget(),
    routes: [
      FFRoute(
        name: '_initialize',
        path: '/',
        builder: (context, _) => GameWidget(),
      ),
      FFRoute(
      ...
      FFRoute(
        name: LavkaWidget.routeName,
        path: LavkaWidget.routePath,
        builder: (context, params) => LavkaWidget(),
      ),
      FFRoute(
